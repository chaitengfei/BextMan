				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>${LoginUser.realName }</h3>
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> 账户管理 <span
										class="fa fa-chevron-down"></span>
								</a>
									<ul class="nav child_menu">
										<li><a href="javascript:;">普通账户申请</a>
										</li>
										<li><a href="javascript:;">个人账户信息维护</a>
										</li>
									</ul></li>
								<li><a><i class="fa fa-edit"></i> 销售信息查询<span
										class="fa fa-chevron-down"></span>
								</a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/sale/list">销售信息查询</a>
										</li>
									</ul></li>
							</ul>
						</div>
